...
simu_matrix_scDesign2_pergene_vec <- rowSums(simu_matrix)
write.table(simu_matrix_scDesign2_pergene_vec, sprintf("%s/%s.scDesign2Simulated.nReadRegionmargional.txt", out.directory, samplename), row.names = FALSE,col.names = FALSE)
