...
# Task: mouse 10X scATAC-seq with trustworthy peaks and nonpeaks
# Date: 20221130
# Notes
...
# Tools directory
script_directory=/home/gayan/Projects/scATAC_Simulator/scripts/03092022/10X_MOUSE_BRAIN/ATAC-seq
...
outdirectory=/home/gayan/Projects/scATAC_Simulator/results/20221130_e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1_NONINPUT
...
# cp 20221121_e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1_NONINPUT/${ref_gt_peak} ${outdirectory}
...
# Ground truth peak
# cp 20220407_e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1_NONINPUT/e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.countmatrix.txt  ${outdirectory}
time(python3 ${script_directory}/NOINPUT_ATAC_BAM2CountMatrix.py ${INPUT_cells_barcode_file} ${outdirectory} ${ref_peakfile} ${INPUT_bamfile} ${outdirectory} ${count_mat_filename}.${count_mat_format})
...
# Ground truth peak
time(Rscript ${script_directory}/NOINPUT_ATAC_SyntheticMat.R ${count_mat_filename} ${count_mat_format} ${outdirectory} ${outdirectory} 1) 
# cp 20221121_e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1_NONINPUT/e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.countmatrix.scDesign2Simulated.txt ${outdirectory}
# Ground truth non-peak
time(Rscript ${script_directory}/NOINPUT_ATAC_SyntheticMat.R ${count_mat_comple_filename} ${count_mat_format} ${outdirectory} ${outdirectory} 0) # 86m8.349s
...
## Generate synthetic read positions in BED file
cd ${outdirectory}
python3 NOINPUT_ATAC_GenerateBAMCoord_20221130_GreyArea.py
# Peaks, set 'random_noise_mode = False'
# cp 20221121_e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1_NONINPUT/${filename}.syntheticBAM.CBincluded.read1.bed 20221121_e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1_NONINPUT/${filename}.syntheticBAM.CBincluded.read2.bed $outdirectory/
# Non-peaks, set 'random_noise_mode = False'
# time(python3 ${script_directory}/NOINPUT_ATAC_GenerateBAMCoord_20221130.py ${outdirectory} ${coordinate_COMPLE_file} ${ref_comple_peakfile} ${synthetic_countmat_file_comple} ${cellnumberfile_comple} ${BED_COMPLE_filename_pre} ${OUTPUT_cells_barcode_file})
...
time(bowtie2 --minins 0 --maxins 1200 -x ${referenceGenome_dir}/${referenceGenome_name} -1 ${outdirectory}/${BED_filename_combined_pre}.read1.bed2fa.sorted.fq -2 ${outdirectory}/${BED_filename_combined_pre}.read2.bed2fa.sorted.fq | samtools view -bS - > ${outdirectory}/${output_BAM_pre}.synthetic.${chr_title}.noCB.bam) # 421 minutes
# bwa_directory=~/Tools/bwa/
# time(${bwa_directory}/bwa mem ${referenceGenome_file} ${outdirectory}/${BED_filename_combined_pre}.read1.bed2fa.sorted.fq ${outdirectory}/${BED_filename_combined_pre}.read2.bed2fa.sorted.fq > ${outdirectory}/${output_BAM_pre}.synthetic.${chr_title}.noCB.bam)
...
# More peaks
${macs3_directory}/macs3 callpeak -f BAMPE -t -g mm -n ${synthetic_MACS3_peakcall_filename}.lessStringent -B -q 0.5
...
## fgbio 
java -jar /home/gayan/Tools/fgbio/target/scala-2.13/fgbio-2.0.1-e884860-SNAPSHOT.jar ErrorRateByReadPosition -i $scReadSim_bamfile -r $referenceGenome_file -o ${outdirectory}/VerifyQuality/fgbio/scReadSim --collapse false
