...
def ATAC_GenerateBAMCoord(bed_file, count_mat_file, read_bedfile_prename, INPUT_bamfile, outdirectory, OUTPUT_cells_barcode_file, jitter_size=5, read_len=50, random_noise_mode = False, grey_area_modeling = True):
	...
	if grey_area_modeling == True:
		...
		with open(outdirectory + "/" + "e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.MACS3_GreyAreas.bed") as file:
			reader = csv.reader(file, delimiter="\t")
...
bed_file = outdirectory + "/" + "e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.MACS3_thr10_peaks.COMPLE.bed"
count_mat_file = "e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.COMPLE.countmatrix.scDesign2Simulated.txt"
read_bedfile_prename = "e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.syntheticBAM.COMPLE.CBincluded"
INPUT_bamfile = "/home/gayan/Projects/scATAC_Simulator/data/10X_MOUSE_BRAIN_ATACandRNA/split.e18_mouse_brain_fresh_5k_atac_possorted_bam/e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.bam"
# read_bedfile_prename = "e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.syntheticBAM.GreyArea.CBincluded"
OUTPUT_cells_barcode_file = outdirectory + "/synthetic_cell_barcode.txt"
random_noise_mode = False
grey_area_modeling = True
read_len = 50
jitter_size=5
# Generate BAM Coordinates for non-peaks while generating reads for grey areas
ATAC_GenerateBAMCoord(bed_file, count_mat_file, read_bedfile_prename, INPUT_bamfile, outdirectory, OUTPUT_cells_barcode_file, jitter_size, read_len, random_noise_mode, grey_area_modeling)


# Peaks, set 'random_noise_mode = False'
# 35:52
outdirectory = "/home/gayan/Projects/scATAC_Simulator/results/20221130_e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1_NONINPUT"
bed_file = outdirectory + "/" + "e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.MACS3_peaks.bed"
count_mat_file = "e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.countmatrix.scDesign2Simulated.txt"
read_bedfile_prename = "e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.syntheticBAM.CBincluded"
INPUT_bamfile = "/home/gayan/Projects/scATAC_Simulator/data/10X_MOUSE_BRAIN_ATACandRNA/split.e18_mouse_brain_fresh_5k_atac_possorted_bam/e18_mouse_brain_fresh_5k_atac_possorted_bam_chr1.bam"
